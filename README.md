# PHP DB Boilerplate (Procedural)

Minimalist, production-ready skeleton for a procedural PHP app running on Nginx + PHP-FPM in a single Docker image.

## Features

- Single Docker image with Nginx + PHP-FPM (no framework)
- Procedural PHP, each page is a standalone script
...
- `app/public/` - public pages and endpoints (each file is a page)
- `app/inc/` - shared includes (`bootstrap.php`, `db.php`, `env.php`)
